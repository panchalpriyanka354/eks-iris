...
export AWS_ACCESS_KEY_ID=AKIA4SDNVOT3P6OBZPV5
export AWS_SECRET_ACCESS_KEY=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
export AWS_DEFAULT_REGION=us-east-1

# Step 2: Log in to Amazon ECR
aws ecr get-login-password --region us-east-1 | docker login --username AWS --password-stdin 863518422262.dkr.ecr.us-east-1.amazonaws.com

# Step 3: Pull the latest Docker image from ECR
sudo docker pull 863518422262.dkr.ecr.us-east-1.amazonaws.com/ecr-iris-repo
...
sudo docker run -d -p 8080:5000 --name ml-iris-app \
  ...
  863518422262.dkr.ecr.us-east-1.amazonaws.com/ecr-iris-repo
